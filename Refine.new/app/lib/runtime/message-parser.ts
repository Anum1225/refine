...
const ARTIFACT_TAG_OPEN = '<refineArtifact';
const ARTIFACT_TAG_CLOSE = '</refineArtifact>';
const ARTIFACT_ACTION_TAG_OPEN = '<refineAction';
const ARTIFACT_ACTION_TAG_CLOSE = '</refineAction>';
