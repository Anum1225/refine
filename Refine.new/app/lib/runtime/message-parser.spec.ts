...
describe('StreamingMessageParser', () => {
  ...
  describe('invalid or incomplete artifacts', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      ...
      ['Foo bar <boltArtifacs></refineArtifact>', 'Foo bar <boltArtifacs></refineArtifact>'],
      ['Before <oltArtfiact>foo</refineArtifact> After', 'Before <oltArtfiact>foo</refineArtifact> After'],
      ['Before <refineArtifactt>foo</refineArtifact> After', 'Before <refineArtifactt>foo</refineArtifact> After'],
    ])('should correctly parse chunks and strip out bolt artifacts (%#)', (input, expected) => {
      runTest(input, expected);
    });
  });
  ...
  describe('valid artifacts without actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Some text before <refineArtifact title="Some title" id="artifact_1">foo bar</refineArtifact> Some more text',
        {
      ...
      [
        [
          ...
          'fact',
          ' title="Some title" id="artifact_1" type="bundled" >foo</refineArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' ',
          '>',
          'foo</refineArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' >fo',
          'o</refineArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        'Before <refineArtifact title="Some title" id="artifact_1">foo</refineArtifact> After',
        {
          output: 'Before  After',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
        },
  ...
  describe('valid artifacts with actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Before <refineArtifact title="Some title" id="artifact_1"><refineAction type="shell">npm install</refineAction></refineArtifact> After',
        {
          output: 'Before  After',
      ...
      [
        'Before <refineArtifact title="Some title" id="artifact_1"><refineAction type="shell">npm install</refineAction><refineAction type="file" filePath="index.js">some content</refineAction></refineArtifact> After',
        {
          output: 'Before  After',
