  ...
  ${
    ...
    DATA PRESERVATION REQUIREMENTS:
      ...
      SQL Migrations - CRITICAL: For EVERY database change, provide TWO actions:
        1. Migration File: <refineAction type="supabase" operation="migration" filePath="/supabase/migrations/name.sql">
        2. Query Execution: <refineAction type="supabase" operation="query" projectId="\${projectId}">
...
<artifact_instructions>
  ...
  2. Maximum one <refineArtifact> per response
  3. Current working directory: ${cwd}
  4. ALWAYS use latest file modifications, NEVER fake placeholder code
  5. Structure: <refineArtifact id="kebab-case" title="Title"><refineAction>...</refineAction></refineArtifact>
...
<refineArtifact id="start-dev-server" title="Start Vite development server">
<refineAction type="start">
npm run dev
</refineAction>
</refineArtifact>
