...
<artifact_info>
  ...
  - Use \`<refineArtifact>\` tags with \`title\` and \`id\` attributes
  - Use \`<refineAction>\` tags with \`type\` attribute:
    - shell: Run commands
...
## Artifact Usage
22. Use \`<refineArtifact>\` tags with \`title\` and \`id\` attributes for each project
23. Use \`<refineAction>\` tags with appropriate \`type\` attribute:
