  ...
  return (
    ...
    >
      <div className="h-full">
        <div className="bg-refine-elements-terminals-background h-full flex flex-col">
          <div className="flex items-center bg-refine-elements-background-depth-2 border-y border-refine-elements-borderColor gap-1.5 min-h-[34px] p-2">
                  ...
                  {index == 0 ? (
                    <button
                      ...
                      className={classNames(
                        ...
                        {
                          'bg-refine-elements-terminals-buttonBackground text-refine-elements-textSecondary hover:text-refine-elements-textPrimary':
                            isActive,
                          'bg-refine-elements-background-depth-2 text-refine-elements-textSecondary hover:bg-refine-elements-terminals-buttonBackground':
                            !isActive,
                        },
                      )}
                    ...
                    <React.Fragment>
                      <button
                        ...
                        className={classNames(
                          'flex items-center text-sm cursor-pointer gap-1.5 px-3 py-2 h-full whitespace-nowrap rounded-full',
                          {
                            'bg-refine-elements-terminals-buttonBackground text-refine-elements-textPrimary': isActive,
                            'bg-refine-elements-background-depth-2 text-refine-elements-textSecondary hover:bg-refine-elements-terminals-buttonBackground':
                              !isActive,
                          },
                        )}
                      ...
                      >
                        ...
                        <button
                          className="bg-transparent text-refine-elements-textTertiary hover:text-refine-elements-textPrimary hover:bg-transparent rounded"
                          onClick={(e) => {
                            e.stopPropagation();
                            closeTerminal(index);
                          }}
