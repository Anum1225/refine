    ...
    <Card className="w-full max-w-md p-6">
      <div className="text-center mb-6">
        ...
        <p className="text-bolt-elements-textSecondary mt-2">
          Join Refine.new and start building amazing projects
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label htmlFor="fullName" className="block text-sm font-medium text-bolt-elements-textPrimary mb-1">
            Full Name
          </label>
          <input
            id="fullName"
      ...
      <div className="mt-6">
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-bolt-elements-bg-depth-1 text-bolt-elements-textSecondary">
              Or continue with
            </span>
          </div>
        </div>
      ...
      <div className="mt-4 text-center">
        <p className="text-xs text-bolt-elements-textSecondary">
          ...
          <a href="/terms" className="text-accent-600 hover:text-accent-700">Terms of Service</a>
          {' '}and{' '}
          <a href="/privacy" className="text-accent-600 hover:text-accent-700">Privacy Policy</a>
        </p>
      </div>
    </Card>
  );
