  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-lg border border-refine-elements-borderColor bg-refine-elements-background-depth-1 text-refine-elements-textPrimary shadow-sm',
        className,
      )}
      {...props}
    />
...
const CardDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    return <p ref={ref} className={classNames('text-sm text-refine-elements-textSecondary', className)} {...props} />;
  },
);
