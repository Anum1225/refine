      ...
      <div className="flex items-center gap-1.5">
        ...
        <span
          className={classNames(
            isLast
              ? 'font-medium text-refine-elements-textPrimary dark:text-refine-elements-textPrimary-dark'
              : 'text-refine-elements-textSecondary dark:text-refine-elements-textSecondary-dark hover:text-refine-elements-textPrimary dark:hover:text-refine-elements-textPrimary-dark',
            ...
            <li key={index} className="flex items-center">
              ...
              {!isLast && (
                <span
                  className={classNames(
                    separator,
                    'w-3 h-3 mx-1 text-refine-elements-textTertiary dark:text-refine-elements-textTertiary-dark',
                  )}
                />
              )}
            </li>
