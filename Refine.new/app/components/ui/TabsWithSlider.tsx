        ...
        <button
          ...
          className={classNames(
            ...
            tab.id === activeTab
              ...
              : classNames(
                  'bg-refine-elements-background-depth-2 dark:bg-refine-elements-background-depth-3 text-refine-elements-textPrimary dark:text-refine-elements-textPrimary-dark hover:bg-refine-elements-background-depth-3 dark:hover:bg-refine-elements-background-depth-4 border border-refine-elements-borderColor dark:border-refine-elements-borderColor-dark',
                  tabClassName,
                ),
          )}
        >
