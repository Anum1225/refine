...
export const Menu = () => {
  ...
  useEffect(() => {
    ...
    const onMouseMove = throttle((event: MouseEvent) => {
      ...
      // More reliable sidebar opening
      if (event.clientX < enterThreshold && event.clientY > 60) {
        setOpen(true);
      }

      // Close sidebar when mouse moves away
    ...
    <>
      <motion.div
        ...
        className={classNames(
          ...
          'sidebar-optimized hardware-accelerated',
          'bg-white/95 dark:bg-gray-950/95 optimized-backdrop border-r border-bolt-elements-borderColor',
          'shadow-2xl text-sm contain-layout',
          'before:absolute before:inset-0 before:bg-gradient-to-b before:from-blue-500/5 before:to-purple-500/5 before:rounded-r-2xl before:-z-10',
